...
### 메가 드롭다운
```css
.dropdown-mega           /* 플렉스 레이아웃, 480px 너비 */
.dropdown-mega-section   /* 각 섹션 */
.dropdown-section-header /* 컬러 헤더 */
```
**자바학습하기** (4열):
- 기초 헤더: `#10B981` (Success 초록)
- 중급 헤더: `#3B82F6` (Info 파랑)
- 고급 헤더: `#E76F00` (Accent 주황)
- 웹 개발 헤더: `#EF4444` (Error 빨강)

**스프링** (2열):
- Framework 헤더: `#10B981` (Success 초록)
- Boot 헤더: `#3B82F6` (Info 파랑)
...
**프로젝트** (4열):
- 기초 헤더: `#10B981` (Success 초록)
- 심화 헤더: `#3B82F6` (Info 파랑)
- 웹 헤더: `#E76F00` (Accent 주황)
- Spring 헤더: `#6DB33F` (Spring 초록)
...
- 전체 61개 콘텐츠 (53레슨 + 8프로젝트) 동일 패턴 적용
