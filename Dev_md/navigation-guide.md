...
기존 4개 드롭다운(기초/중급/고급/웹개발)을 1개 메가 드롭다운 + 2개 일반 드롭다운으로 변경.

## Navbar 구조
```
[로고] [자바학습하기▼] [서블릿▼] [스프링▼] [커리큘럼] [퀴즈] [도장깨기] [가이드] [마이페이지] [진도] [테마] [로그인]
```
...
| 고급 | `#E76F00` (Accent 주황) | 09~17 (제네릭~데이터접근) |
...
## 진도 원형 그래프
- SVG 기반 원형 진도 표시
- `ProgressContext.getTotalProgress()` 사용 (43개 레슨 기준)
