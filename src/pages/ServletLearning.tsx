...
export default function ServletLearning() {
  const { isLessonCompleted, getServletProgress } = useProgress()
  const progress = getServletProgress()
    ...
    <main>
      <div className="page-header">
        <div className="container">
          ...
          <h1>서블릿 학습 과정</h1>
          <p>HTTP와 서블릿의 기초부터 MVC 패턴, CRUD 프로젝트까지 (40시간)</p>
