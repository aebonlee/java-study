...
// (0,0) (0,1) (0,2) (1,0)`})})]}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"1부터 100까지 짝수의 합을 구하는 프로그램을 작성하세요."}),e.jsx("li",{children:"switch 문으로 월(1~12)을 입력받아 해당 월의 계절을 출력하세요."}),e.jsx("li",{children:"구구단 중 3의 배수 단(3, 6, 9단)만 출력하세요."}),e.jsx("li",{children:"1부터 시작하여 합이 1000을 넘는 최초의 수를 찾으세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${n("03")?"btn-secondary":"btn-accent"}`,onClick:()=>i("03"),children:n("03")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/java-learning/02",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: 변수와 자료형"]}),e.jsxs(s,{to:"/java-learning/04",children:["다음: 배열과 문자열 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{c as default};
