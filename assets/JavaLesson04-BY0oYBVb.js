...
// %10s : 오른쪽 정렬 (폭 10)
// %-10s : 왼쪽 정렬
// %.2f : 소수점 2자리`})})]}),s.jsxs("div",{className:"exercise-box",children:[s.jsxs("h4",{children:[s.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),s.jsxs("ol",{children:[s.jsx("li",{children:"정수 배열에서 최대값과 최소값을 찾는 프로그램을 작성하세요."}),s.jsx("li",{children:"3x3 행렬의 전치 행렬(행과 열을 바꿈)을 구하세요."}),s.jsx("li",{children:"문자열을 입력받아 각 문자의 빈도수를 세는 프로그램을 만드세요."}),s.jsx("li",{children:"StringBuilder를 사용하여 문자열을 뒤집는 메서드를 작성하세요."})]})]}),s.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:s.jsx("button",{className:`btn ${r("04")?"btn-secondary":"btn-accent"}`,onClick:()=>i("04"),children:r("04")?"✓ 학습 완료!":"학습 완료하기"})}),s.jsxs("div",{className:"lesson-nav",children:[s.jsxs(e,{to:"/java-learning/03",children:[s.jsx("i",{className:"fas fa-arrow-left"})," 이전: 연산자와 제어문"]}),s.jsxs(e,{to:"/java-learning/05",children:["다음: 클래스와 객체 ",s.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{t as default};
