...
}`})})]}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"8가지 기본 자료형을 각각 선언하고 값을 출력하는 프로그램을 작성하세요."}),e.jsxs("li",{children:[e.jsx("code",{children:"int"}),"형 변수에 2,000,000,000을 저장하고, 1,000,000,000을 더한 결과를 확인해보세요. (오버플로우)"]}),e.jsxs("li",{children:[e.jsx("code",{children:"double"})," 값을 ",e.jsx("code",{children:"int"}),"로 형변환할 때 결과를 예측하고 확인해보세요."]}),e.jsxs("li",{children:[e.jsx("code",{children:"var"})," 키워드를 사용하여 다양한 타입의 변수를 선언해보세요."]})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${i("02")?"btn-primary":"btn-accent"}`,onClick:()=>l("02"),children:i("02")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/java-learning/01",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: Java 소개"]}),e.jsxs(s,{to:"/java-learning/03",children:["다음: 연산자와 제어문 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{r as default};
