...
Collections.unmodifiableList(list); // 읽기 전용 래퍼`})})]}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsxs("li",{children:["사용자 정의 예외 ",e.jsx("code",{children:"InvalidAgeException"}),"을 만들어 나이 유효성 검사에 사용하세요."]}),e.jsx("li",{children:"ArrayList에 학생 이름을 저장하고 알파벳순으로 정렬하여 출력하세요."}),e.jsx("li",{children:"HashMap으로 전화번호부를 구현하세요 (이름-번호 저장, 검색, 삭제)."}),e.jsx("li",{children:"HashSet으로 두 리스트의 교집합, 합집합, 차집합을 구하세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${a("08")?"btn-secondary":"btn-accent"}`,onClick:()=>i("08"),children:a("08")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/java-learning/07",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: 인터페이스와 추상클래스"]}),e.jsxs(s,{to:"/java-learning/09",children:["다음: 제네릭과 열거형 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{l as default};
