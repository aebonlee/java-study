...
}`,title:"프록시 패턴으로 이해하는 AOP 원리"}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"AOP의 핵심 용어(Aspect, Advice, Pointcut, JoinPoint)를 각각 설명하세요."}),e.jsxs("li",{children:["@Around Advice에서 ",e.jsx("code",{children:"ProceedingJoinPoint.proceed()"}),"를 호출하지 않으면 어떻게 되나요?"]}),e.jsxs("li",{children:["다음 Pointcut 표현식의 의미를 설명하세요: ",e.jsx("code",{children:"execution(* com.example..*Service.find*(..))"})]}),e.jsx("li",{children:"@Transactional이 AOP로 동작하기 때문에 같은 클래스 내부 호출에서 동작하지 않는 이유를 설명하세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${i("SP04")?"btn-secondary":"btn-accent"}`,onClick:()=>s("SP04"),children:i("SP04")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(r,{to:"/spring/03",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: Spring Bean과 컨테이너"]}),e.jsxs(r,{to:"/spring/05",children:["다음: Spring MVC 기초 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{d as default};
