...
String result = Optional.ofNullable(getUserName())
    ...
    .orElse("Anonymous");`})})]}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"정수 리스트에서 홀수만 골라 3배한 결과를 새 리스트로 만드세요."}),e.jsx("li",{children:"문자열 리스트에서 가장 긴 문자열을 Optional로 찾으세요."}),e.jsx("li",{children:"학생 리스트를 성적순으로 정렬하고, 상위 3명을 출력하세요."}),e.jsx("li",{children:"Map으로 단어 빈도수를 세는 스트림 파이프라인을 작성하세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${r("10")?"btn-secondary":"btn-accent"}`,onClick:()=>n("10"),children:r("10")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/java-learning/09",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: 제네릭과 열거형"]}),e.jsxs(s,{to:"/java-learning/11",children:["다음: 멀티스레드 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{i as default};
