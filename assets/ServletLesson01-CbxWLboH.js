...
}`,title:"서블릿 동작 흐름 시뮬레이션"}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsxs("li",{children:["JDK와 Tomcat을 설치하고, ",e.jsx("code",{children:"http://localhost:8080"}),"에 접속하여 Tomcat 기본 페이지를 확인해보세요."]}),e.jsxs("li",{children:["HelloServlet을 작성하고 ",e.jsx("code",{children:"@WebServlet"})," 어노테이션으로 URL을 매핑해보세요."]}),e.jsxs("li",{children:["서블릿에서 현재 날짜와 시간을 HTML로 출력하는 ",e.jsx("code",{children:"TimeServlet"}),"을 만들어보세요."]}),e.jsx("li",{children:"웹 서버(Apache)와 WAS(Tomcat)의 차이점을 정리하고, 왜 실무에서 함께 사용하는지 설명해보세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${l("S01")?"btn-secondary":"btn-accent"}`,onClick:()=>t("S01"),children:l("S01")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/servlet",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: 서블릿 허브"]}),e.jsxs(s,{to:"/servlet/02",children:["다음: HTTP 프로토콜과 요청/응답 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{d as default};
