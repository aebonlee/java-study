...
}`})})]}),s.jsxs("div",{className:"exercise-box",children:[s.jsxs("h4",{children:[s.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),s.jsxs("ol",{children:[s.jsxs("li",{children:["JDK를 설치하고 ",s.jsx("code",{children:"java -version"})," 명령어로 버전을 확인해보세요."]}),s.jsx("li",{children:'"Hello, World!"를 출력하는 프로그램을 작성하고 컴파일, 실행해보세요.'}),s.jsx("li",{children:"자신의 이름과 나이를 출력하는 프로그램을 작성해보세요."}),s.jsx("li",{children:"Scanner를 사용하여 사용자 입력을 받아 인사하는 프로그램을 만들어보세요."})]})]}),s.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:s.jsx("button",{className:`btn ${l("01")?"btn-secondary":"btn-accent"}`,onClick:()=>a("01"),children:l("01")?"✓ 학습 완료!":"학습 완료하기"})}),s.jsxs("div",{className:"lesson-nav",children:[s.jsxs(e,{to:"/",children:[s.jsx("i",{className:"fas fa-arrow-left"})," 홈으로"]}),s.jsxs(e,{to:"/java-learning/02",children:["다음: 변수와 자료형 ",s.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{r as default};
