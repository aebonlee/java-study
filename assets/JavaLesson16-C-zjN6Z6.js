...
record ErrorResponse(String code, String message) {}`})})]}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"Spring Boot로 TODO 목록 REST API(CRUD)를 구현하세요."}),e.jsx("li",{children:"@Valid를 사용하여 입력값 검증을 추가하세요."}),e.jsx("li",{children:"@ControllerAdvice로 전역 예외 처리를 구현하세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${r("16")?"btn-secondary":"btn-accent"}`,onClick:()=>i("16"),children:r("16")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/java-learning/15",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: Spring Framework"]}),e.jsxs(s,{to:"/java-learning/17",children:["다음: Spring MVC와 데이터 접근 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{l as default};
