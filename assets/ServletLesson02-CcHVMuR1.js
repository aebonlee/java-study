...
}`,title:"HTTP 요청/응답 파싱 시뮬레이션"}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsxs("li",{children:[e.jsx("code",{children:"HttpServletRequest"}),"를 사용하여 모든 요청 헤더를 출력하는 서블릿을 작성해보세요."]}),e.jsx("li",{children:"GET과 POST 요청을 모두 처리하는 서블릿을 만들고, 각각 다른 응답을 반환해보세요."}),e.jsxs("li",{children:[e.jsx("code",{children:"response.sendRedirect()"}),"를 사용하여 다른 페이지로 리다이렉트하는 서블릿을 만들어보세요."]}),e.jsx("li",{children:"상태 코드 404를 반환하면서 커스텀 에러 페이지를 보여주는 서블릿을 작성해보세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${t("S02")?"btn-secondary":"btn-accent"}`,onClick:()=>r("S02"),children:t("S02")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/servlet/01",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: 서블릿 개요와 환경설정"]}),e.jsxs(s,{to:"/servlet/03",children:["다음: 서블릿 생명주기 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{h as default};
