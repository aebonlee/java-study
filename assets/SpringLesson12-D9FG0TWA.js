...
}`,title:"커스텀 예외와 공통 응답 패턴"}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"BusinessException을 상속하는 커스텀 예외를 3개 이상 만들어 보세요."}),e.jsx("li",{children:"@ControllerAdvice로 전역 예외 처리기를 구현하고, 각 예외에 맞는 HTTP 상태 코드를 반환하세요."}),e.jsx("li",{children:"ApiResponse 공통 응답 객체를 만들어 모든 API에 적용해 보세요."}),e.jsx("li",{children:"@Valid와 함께 Validation 어노테이션을 사용하여 입력값을 검증하고, 에러 메시지를 반환해 보세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${r("SP12")?"btn-secondary":"btn-accent"}`,onClick:()=>t("SP12"),children:r("SP12")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/spring/11",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: Spring Data JPA"]}),e.jsxs(s,{to:"/spring/13",children:["다음: Spring Security + JWT ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{l as default};
