...
descriptions.put(Season.SUMMER, "무더운 여름");`})})]}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsxs("li",{children:["두 개의 타입 매개변수를 가진 ",e.jsx("code",{children:"Pair<K, V>"})," 클래스를 작성하세요."]}),e.jsx("li",{children:"와일드카드를 사용하여 모든 숫자 리스트의 평균을 구하는 메서드를 만드세요."}),e.jsx("li",{children:"요일 enum을 만들고 평일/주말을 판별하는 메서드를 추가하세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${n("09")?"btn-secondary":"btn-accent"}`,onClick:()=>a("09"),children:n("09")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/java-learning/08",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: 예외처리와 컬렉션"]}),e.jsxs(s,{to:"/java-learning/10",children:["다음: 람다와 스트림 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{t as default};
