...
}`,title:"JUnit5 테스트 패턴 시뮬레이션"}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"서비스 클래스에 대해 Mockito를 활용한 단위 테스트를 3개 이상 작성해 보세요."}),e.jsx("li",{children:"MockMvc를 사용하여 GET, POST, PUT, DELETE API를 각각 테스트해 보세요."}),e.jsx("li",{children:"@ParameterizedTest를 사용하여 여러 입력값으로 동일한 테스트를 실행해 보세요."}),e.jsx("li",{children:"JaCoCo를 설정하고 테스트 커버리지 80% 이상을 달성해 보세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${t("SP14")?"btn-secondary":"btn-accent"}`,onClick:()=>i("SP14"),children:t("SP14")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/spring/13",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: Spring Security + JWT"]}),e.jsxs(s,{to:"/spring/15",children:["다음: Swagger/OpenAPI 문서화 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{n as default};
