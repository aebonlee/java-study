...
}`,title:"Bean Validation 개념 체험"}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"@NotNull, @NotEmpty, @NotBlank의 차이점을 설명하세요."}),e.jsx("li",{children:"BindingResult를 @Valid 바로 뒤에 선언해야 하는 이유를 설명하세요."}),e.jsx("li",{children:'"비밀번호와 비밀번호 확인이 일치하는지" 검증하는 커스텀 Validator를 설계하세요.'}),e.jsx("li",{children:"국제화(i18n) 메시지 소스를 사용할 때 메시지 우선순위 규칙을 설명하세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${s("SP06")?"btn-secondary":"btn-accent"}`,onClick:()=>i("SP06"),children:s("SP06")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(r,{to:"/spring/05",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: Spring MVC 기초"]}),e.jsxs(r,{to:"/spring/07",children:["다음: MyBatis 연동 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{d as default};
