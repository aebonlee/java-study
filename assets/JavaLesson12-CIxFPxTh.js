...
client.sendAsync(request, HttpResponse.BodyHandlers.ofString())
    ...
    .thenAccept(System.out::println);`})})]}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"NIO를 사용하여 텍스트 파일의 단어 수를 세는 프로그램을 작성하세요."}),e.jsx("li",{children:"특정 디렉토리에서 .java 파일만 찾아 목록을 출력하세요."}),e.jsx("li",{children:"HttpClient로 REST API를 호출하고 JSON 응답을 파싱하세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${s("12")?"btn-secondary":"btn-accent"}`,onClick:()=>a("12"),children:s("12")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(t,{to:"/java-learning/11",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: 멀티스레드"]}),e.jsxs(t,{to:"/java-learning/13",children:["다음: 서블릿 기초 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{l as default};
