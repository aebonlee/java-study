...
}`,title:"REST API DTO 패턴 실습"}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsx("li",{children:"도서(Book) 관리 REST API의 URL을 설계하세요. (CRUD + 검색)"}),e.jsx("li",{children:"@PathVariable, @RequestParam, @RequestBody의 차이를 정리하고, 각각 활용 예제를 작성하세요."}),e.jsx("li",{children:"ResponseEntity를 사용하여 성공/실패에 따라 다른 HTTP 상태 코드를 반환하는 API를 구현하세요."}),e.jsx("li",{children:"POST와 PUT의 차이를 설명하고, 각각 어떤 상황에서 사용하는지 예를 들어 보세요."})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${s("SP10")?"btn-secondary":"btn-accent"}`,onClick:()=>i("SP10"),children:s("SP10")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(t,{to:"/spring/09",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: Spring Boot 시작하기"]}),e.jsxs(t,{to:"/spring/11",children:["다음: Spring Data JPA ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{d as default};
