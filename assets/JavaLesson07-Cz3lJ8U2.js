...
Outer.StaticInner si = new Outer.StaticInner();`})})]}),e.jsxs("div",{className:"exercise-box",children:[e.jsxs("h4",{children:[e.jsx("i",{className:"fas fa-pencil-alt"})," 연습문제"]}),e.jsxs("ol",{children:[e.jsxs("li",{children:[e.jsx("code",{children:"Comparable"})," 인터페이스를 구현하여 ",e.jsx("code",{children:"Student"})," 객체를 성적순으로 정렬하세요."]}),e.jsxs("li",{children:[e.jsx("code",{children:"Printable"}),", ",e.jsx("code",{children:"Saveable"})," 두 인터페이스를 만들고 다중 구현하는 ",e.jsx("code",{children:"Document"})," 클래스를 작성하세요."]}),e.jsxs("li",{children:["추상 클래스 ",e.jsx("code",{children:"Vehicle"}),"과 인터페이스 ",e.jsx("code",{children:"Electric"}),"을 조합하여 ",e.jsx("code",{children:"ElectricCar"})," 클래스를 만드세요."]})]})]}),e.jsx("div",{style:{marginTop:"32px",textAlign:"center"},children:e.jsx("button",{className:`btn ${i("07")?"btn-secondary":"btn-accent"}`,onClick:()=>r("07"),children:i("07")?"✓ 학습 완료!":"학습 완료하기"})}),e.jsxs("div",{className:"lesson-nav",children:[e.jsxs(s,{to:"/java-learning/06",children:[e.jsx("i",{className:"fas fa-arrow-left"})," 이전: 상속과 다형성"]}),e.jsxs(s,{to:"/java-learning/08",children:["다음: 예외처리와 컬렉션 ",e.jsx("i",{className:"fas fa-arrow-right"})]})]})]})})]})}export{a as default};
